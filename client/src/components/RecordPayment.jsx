...
// // //   // Calculate week number from start date - IMPROVED LOGIC
// // //   // const getWeekNumber = (startDate, currentDate) => {
// // //   //   const start = new Date(startDate);
// // //   //   start.setHours(0, 0, 0, 0);
...
// // //   //   // If start date is after the Sunday of its week, first payment is next Sunday
// // //   //   const adjustedStartSunday =
// // //   //     start > startSunday
...
// // //   //   // Calculate difference in milliseconds
// // //   //   const diffTime = currentSunday - adjustedStartSunday;

// // //   //   // Convert to weeks (ensure positive number)
...
// // //   // Calculate first payment Sunday
// // //   const firstPaymentSunday = start > startSunday ?
// // //     new Date(startSunday.getTime() + 7 * 24 * 60 * 60 * 1000) :
// // //     startSunday;
...
// // //   // Calculate difference in milliseconds from first payment Sunday
// // //   const diffTime = currentSunday - firstPaymentSunday;
...
// // //   //     // If start date falls on Sunday, use that Sunday
// // //   //     // If start date falls after Sunday, use next Sunday
// // //   //     const adjustedStartSunday =
// // //   //       startDate > startSunday
// // //   //         ? new Date(startSunday.getTime() + 7 * 24 * 60 * 60 * 1000)
// // //   //         : startSunday;

// // //   //     const hasStarted = currentSunday >= adjustedStartSunday;
...
// // //       // Check if the current period has started
// // //       const startDate = new Date(user.startDate);
// // //       const startSunday = getSundayOfWeek(startDate);

// // //       // Calculate the first payment Sunday
// // //       // If start date is after the Sunday of its week, first payment is next Sunday
// // //       // If start date is on or before Sunday, first payment is that Sunday
// // //       const firstPaymentSunday =
// // //         startDate > startSunday
// // //           ? new Date(startSunday.getTime() + 7 * 24 * 60 * 60 * 1000)
// // //           : startSunday;

// // //       const hasStarted = currentSunday >= firstPaymentSunday;
...
// //   // Calculate week number from start date - CORRECTED LOGIC
// //   const getWeekNumber = (startDate, currentDate) => {
// //     const start = new Date(startDate);
// //     start.setHours(0, 0, 0, 0);
...
// //   // Check if user should pay for current period - CORRECTED LOGIC
// //   const shouldPayForPeriod = (user) => {
// //     if (paymentType === "week") {
// //       const currentSunday = getSundayOfWeek(currentDate);
// //       const weekNumber = getWeekNumber(user.startDate, currentDate);
...
//       console.log(`User: ${user.memberName}`);
//       console.log(`Start Date: ${startDate.toLocaleDateString()}`);
//       console.log(`Current Sunday: ${currentSunday.toLocaleDateString()}`);
//       console.log(
//         `First Payment Sunday: ${firstPaymentSunday.toLocaleDateString()}`
//       );
//       console.log(`Week Number: ${weekNumber}, Tenure: ${user.tenure}`);
//       console.log(`IsValidWeek: ${isValidWeek}, HasStarted: ${hasStarted}`);
//       console.log(`Should Pay: ${isValidWeek && hasStarted}`);
//       console.log("---");
